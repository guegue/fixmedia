 ...
 */
$config['site_title']           = "Re:media"; 		// Site Title, example.com
$config['admin_email']          = "root@remedia.la"; 	// Admin Email, admin@example.com
...
$config['user_expire']          = 1296000; 				// How long to remember the user (seconds)
