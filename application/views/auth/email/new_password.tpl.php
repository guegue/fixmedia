    ...
    <table width="600" align="center" cellpadding="0" cellspacing="0">
        ...
        <tr style="background:#ffffff;">
            <td style="font-size:14px; color:#7F7F7F; line-height:21px; font-family:Arial, helvetica;padding:0px 50px;">
                <h1 style="font-size:21px; font-style:italic; color:#3D87B7;"><? _e('Nueva contraseña para'); ?> <?php echo $identity;?></h1>
                <p><? _e('Tu nueva contraseña es:'); ?> <?php echo $new_password;?></p>
            </td>
        </tr>
        <tr>
