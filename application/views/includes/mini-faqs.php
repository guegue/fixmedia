	...
	<section class="block">
		<h3 class="title"><a href="<?= site_url($this->router->reverseRoute('statics', array('page' =>  _('como-funciona')))); ?>"><? _e('¿Cómo funciona?'); ?></a></h3>
		<div class="side_text">
			<p><? _e('¡Muy simple! Haz “Fix” para sumarte a una petición de mejora o reporta tú mismo la tuya.'); ?></p>
		</div>
	</section>
	<section class="block">
		<h3 class="title"><a href="<?= site_url($this->router->reverseRoute('statics', array('page' =>  _('que-queremos-conseguir')))); ?>"><? _e('¿Por qué?'); ?></a></h3>
		<div class="side_text">
			<p><? _e('Las noticias son el ADN de la Opinión Pública, que es el poder ciudadano en democracia. Creemos que necesitan un control de calidad ejercido por todos.'); ?></p>
		</div>
	</section>
	<section class="block">
