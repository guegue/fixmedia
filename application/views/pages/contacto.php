<div id="container" class="columns static clearfix">
	<div id="content">
		...
		<p class="sub_title sep">Si tienes cualquier cosa que comentarnos, puedes escribirnos a: <a href="mailto:comunidad@remedia.la">comunidad@remedia.la</a></p>
		<p>A través de RE:media cualquier persona puede -con dos clics- reportar errores y aportar ampliaciones a las noticias de cualquier sitio online. Todo con una herramienta común, independiente, neutra y meritocrática, donde la comunidad de personas interesadas en mejorar las noticias podrán valorar la idoneidad (o no) de las correcciones y ampliaciones aportadas.</p>
		<p>RE:media es un proyecto de la empresa social <a href="http://nxtmdia.com">Nxtmdia</a>.</p>
