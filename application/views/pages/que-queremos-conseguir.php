<div id="container" class="columns static clearfix">     
	<div id="content">         
		<h1 class="title">¿Qué queremos conseguir?</h1>         
		<p class="sub_title sep">Las noticias son el ADN de la Opinión Pública, que es el poder ciudadano en democracia. Creemos que necesitan un control de calidad ejercido por todos.</p>         
		<p>Las noticias son por definición un contenido público, ya que son la materia prima de la agenda pública y por tanto, la base a partir de la cual se crea la opinión pública, el verdadero poder en una democracia. .</p>         
		<h2 class="toggle">Opinión pública</h2>         
		<div class="wrap-title sep">
		<p>No obstante, por ahora, la creación y difusión de la mayor parte de las noticias se hace en un marco cerrado puesto que son consideradas como el “producto” del negocio de los medios de comunicación, una industria con sus propios y legítimos intereses, que a veces chocan con los de la ciudadanía. Todo ello acaba afectando a la forma quizá poco transparente en que se construye aún hoy la opinión pública, como demuestran teorías como la de la ‘Espiral del Silencio’ de Noelle-Neumann.</p>
		</div>
