<div id="container" class="columns static clearfix">
	<div id="content">
		...
		<p class="center"><img class="border" alt="Hacer fix" src="<?= base_url('static/bookmarklet/bookmarklet-1.png'); ?>"/></p>
		<p>El marcador RE:media es un <a href="http://es.wikipedia.org/wiki/Bookmarklet" target="_blank">bookmarklet</a> que te permite arreglar las noticias directamente desde la web donde la estás leyendo, sin necesidad de abrir otra pestaña o ventana para ir a Remedia.la a hacer FIX o aportar tu propio reporte.</p>
		...
		<p>Al hacer clic en el botón de FIX, te llevará en otra pestaña a RE:media para completar el proceso.</p>
		...
		<p>Como ves, además, te mostrará el número de FIX acumulados y te dará la opción de sumar tu propio FIX (haciendo clic en el botón amarillo), ver la noticia en Remedia.la o, incluso, ir directamente a añadir tu propio reporte de mejora.</p>

 		<p>¡Así de fácil!</p>

		<p class="small"><strong>Importante</strong>: El marcador de RE:media NO guarda ningún tipo de información de tu navegación ni ningún dato personal. Los FIX y reportes que hagas desde tu marcador aparecerán en tu perfil igual que si los hubieras hecho desde Remedia.la.</p>
